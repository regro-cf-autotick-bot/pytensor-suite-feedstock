...
pixi add pytensor pytensor-base
# for installing globally
pixi global install pytensor pytensor-base
```
...
It is possible to list all of the versions of `pytensor` available on your platform:
...
```
pixi search pytensor --channel conda-forge
```
